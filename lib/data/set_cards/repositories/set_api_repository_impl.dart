...
class SetApiRepositoryImpl implements SetApiRepository {
  ...
  @override
  Future<Either<Failure, List<SetModel>>> obtenerDefaultSets() async {
    Uri uri = Uri.parse('${apiSettings.apiSupabaseUrl}/card_sets?is_default=eq.true');
    logger.d("API URL: '${apiSettings.apiSupabaseUrl}/card_sets?is_default=eq.true'");
    try {
